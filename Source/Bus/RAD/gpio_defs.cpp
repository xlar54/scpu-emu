...
void gpioInit()
{
	...
	// These were commented out in RAD-Doom, which is where this file came from,
	// but the stock RAD firmware enables them -- and RAD is the bus-mastering
	// reference. They hold the latch and transceiver control lines at defined
	// levels rather than letting them float, which matters because we drive the
	// C64 bus continuously rather than in short bursts.
